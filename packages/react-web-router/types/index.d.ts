...
import { BrowserHistoryActions, BrowserRoutePayload, Location, RouteConfig } from '@medux/route-plan-a';
...
export declare const toBrowserUrl: import("../../route-plan-a/types").ToBrowserUrl<any>;
