(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom/server'), require('react-redux'), require('react-dom'), require('history')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom/server', 'react-redux', 'react-dom', 'history'], factory) :
  (global = global || self, factory(global.MeduxRWR = {}, global.React, global.ReactDOMServer, global.ReactRedux, global.ReactDOM, global.History));
}(this, (function (exports, React, server, reactRedux, ReactDOM, history) { 'use strict';
  ...
  function buildTransformRoute(routeConfig, getCurPathname) {
    ...
    var transformRoute = {
      locationToRoute: function locationToRoute(location) {
        ...
        var routeData = assignRouteData(paths, deepExtend(pathsArgs, params), safeLocation.action);
        cacheData.unshift({
          url: url,
          routeData: routeData
        });
