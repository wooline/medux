import React, { useMemo, useEffect, useLayoutEffect, useContext, useReducer, useRef, useState } from 'react';
...
var Else = React.memo(ElseComponent);
...
var Switch = React.memo(SwitchComponent);

function isModifiedEvent(event) {
  return !!(event.metaKey || event.altKey || event.ctrlKey || event.shiftKey);
}

var Link = React.forwardRef(function (_ref6, ref) {
