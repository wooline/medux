import {historyActions, getCurRouteState, getNativeHistory, getNativeHistory2, ViewNames} from './tools';

describe('history', () => {
  test('init', async () => {
    await historyActions.init({pathname: '/', search: '', hash: ''});
    expect(getNativeHistory()).toEqual(['1|/photos']);
  ...
  test('push /photos/2', async () => {
    ...
    expect(getNativeHistory()).toEqual(['2|/photos/2', '1|/photos']);
    expect(getCurRouteState()).toEqual({
      location: {
        pathname: '/photos/2',
        search: '',
  ...
  test('push /photos/2?q={"photos":{"listSearch":{"page":2}}}', async () => {
    ...
    expect(getNativeHistory()).toEqual(['3|/photos/2?q={"photos":{"listSearch":{"page":2}}}', '2|/photos/2', '1|/photos']);
    expect(getCurRouteState()).toEqual({
      location: {
        pathname: '/photos/2',
  ...
  test('push /photos/2?q={"photos":{"listSearch":{"page":3}}}', async () => {
    ...
    expect(getNativeHistory()).toEqual(['4|/photos/2?q={"photos":{"listSearch":{"page":3}}}', '3|/photos/2?q={"photos":{"listSearch":{"page":2}}}', '2|/photos/2', '1|/photos']);
    expect(getCurRouteState()).toEqual({
      location: {
        pathname: '/photos/2',
  ...
  test('push /photos/2/comments', async () => {
    ...
    expect(getNativeHistory()).toEqual([
      '5|/photos/2/comments',
  ...
  test('pop 1', async () => {
    ...
    expect(getNativeHistory2()).toEqual(['8|/photos/2/comments#q={"photos":{"_listKey":"sdk"},"comments":{"_listKey":"bde"}}']);
    expect(getCurRouteState()).toEqual({
      location: {
        pathname: '/photos/2/comments',
        search: '',
