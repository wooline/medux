...
for(var m in b={},h)h[m]&&h.hasOwnProperty(m)&&(b[m]=(0,_objectSpread2.default)({},h[m]));e.reduce(function(a,g,h){var j=a+"/"+g,k=c[j],l=g.split(_core.config.VSP)[0];//最深的一个view可以决定pathname
if(h===e.length-1){// const toPath = compileToPath(rule.replace(/\$$/, ''));
var n=(0,_matchPath.compileToPath)(k);i=n(f[l])}//pathname中传递的值可以不在params中重复传递
