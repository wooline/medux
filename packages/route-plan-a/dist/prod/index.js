import _objectSpread from"@babel/runtime/helpers/esm/objectSpread";import{compilePath,compileToPath,matchPath}from"./matchPath";import assignDeep from"deep-extend";import{config as coreConfig}from"@medux/core";var config={escape:!0,dateParse:!0,splitKey:"q",defaultRouteParams:{}};export function setConfig(a){a.escape!==void 0&&(config.escape=a.escape),a.dateParse!==void 0&&(config.dateParse=a.dateParse),a.splitKey&&(config.splitKey=a.splitKey),a.defaultRouteParams&&(config.defaultRouteParams=a.defaultRouteParams)}// interface Location {
//   pathname: string;
//   search: string;
//   hash: string;
//   state: RouteData;
...
function excludeDefaultData(a,b){var c={};return Object.keys(a).forEach(function(d){var e=a[d],f=b[d];e!==f&&(typeof e==typeof f&&"object"==typeof e&&!Array.isArray(e)&&(e=excludeDefaultData(e,f)),void 0!==e&&(c[d]=e))}),0===Object.keys(c).length?void 0:c}// 合并默认路由参数，如果路由中某参数没传，将用默认值替代，与上面方法互逆
...
*/function searchParse(a){if(!a)return{};config.escape&&(a=unescape(a));try{return JSON.parse(a,config.dateParse?dateParse:void 0)}catch(a){return{}}}function joinSearchString(a){for(var b=[],c=0,d=a.length;c<d;c++)b.push(a[c]||"");return b.join(config.splitKey+"=")}function searchStringify(a){if("object"!=typeof a)return"";var b=JSON.stringify(a);return"{}"===b?"":config.escape?escape(b):b}function splitSearch(a){var b=new RegExp("[&?#]"+config.splitKey+"=","g"),c=a.match(b),d=[];return c&&(d=c.map(function(a){return searchParse(a.split("=")[1])})),d}function pathnameParse(a,b,c,d){for(var l in b)if(b.hasOwnProperty(l)){var e=b[l],f="string"==typeof e?[e,null]:e,g=f[0],h=f[1],i=matchPath(a,{path:l,exact:!h});// const match = matchPath(pathname, {path: rule.replace(/\$$/, ''), exact: rule.endsWith('$')});
if(i){c.push(g);var j=g.split(coreConfig.VSP)[0],k=i.params;return k&&0<Object.keys(k).length&&(d[j]=_objectSpread({},d[j],k)),void(h&&pathnameParse(a,h,c,d))}}}function compileConfig(a,b,c,d){// ruleToKeys将每条rule中的params key解析出来
for(var l in void 0===b&&(b=""),void 0===c&&(c={}),void 0===d&&(d={}),a)if(a.hasOwnProperty(l)){if(!d[l]){var e=compilePath(l,{end:!0,strict:!1,sensitive:!1}),f=e.keys;d[l]=f.reduce(function(a,b){return a.push(b.name),a},[])}var g=a[l],h="string"==typeof g?[g,null]:g,i=h[0],j=h[1],k=b+"/"+i;c[k]=l,j&&compileConfig(j,k,c,d)}return{viewToRule:c,ruleToKeys:d}}function assignRouteData(a,b,c){b[0]||(b[0]={});var d=b[0];c&&assignDeep(d,c);var e=a.reduce(function(a,b){var c=b.split(coreConfig.VSP),e=c[0],f=c[1];return f&&(!a[e]&&(a[e]={}),a[e][f]=!0,!d[e]&&(d[e]={})),a},{});Object.keys(d).forEach(function(a){d[a]=assignDeep({},config.defaultRouteParams[a],d[a])});var f=assignDeep.apply(void 0,[{}].concat(b));return Object.keys(f).forEach(function(a){d[a]||(f[a]=assignDeep({},config.defaultRouteParams[a],f[a]))}),{views:e,paths:a,params:f,stackParams:b}}export function fillRouteData(a){var b=a.extend||{views:{},paths:[],stackParams:[],params:{}},c=[].concat(b.stackParams);return a.stackParams&&a.stackParams.forEach(function(a,b){a&&(c[b]=assignDeep({},c[b],a))}),assignRouteData(a.paths||b.paths,c)}function extractHashData(a){var b={},c={},d=function(d){if(a[d]&&a.hasOwnProperty(d)){var e=a[d],f=Object.keys(e);0<f.length&&f.forEach(function(a){a.startsWith("_")?(!c[d]&&(c[d]={}),c[d][a]=e[a]):(!b[d]&&(b[d]={}),b[d][a]=e[a])})}};for(var e in a)d(e);return{search:searchStringify(b),hash:searchStringify(c)}}export function buildTransformRoute(a){var b=compileConfig(a),c=b.viewToRule,d=b.ruleToKeys;return{locationToRoute:function locationToRoute(b){var c=[],d={};pathnameParse(b.pathname,a,c,d);var e=splitSearch(b.search),f=splitSearch(b.hash);return f.forEach(function(a,b){a&&assignDeep(e[b],a)}),assignRouteData(c,e,d)},routeToLocation:function routeToLocation(a){var b,e=a.paths,f=a.params,g=a.stackParams,h=g[0],i="";if(0<e.length){// 将args二层克隆params，因为后面可能会删除path中使用到的变量
for(var m in b={},h)h[m]&&h.hasOwnProperty(m)&&(b[m]=_objectSpread({},h[m]));e.reduce(function(a,g,h){var j=a+"/"+g,k=c[j],l=g.split(coreConfig.VSP)[0];//最深的一个view可以决定pathname
if(h===e.length-1){// const toPath = compileToPath(rule.replace(/\$$/, ''));
var n=compileToPath(k);i=n(f[l])}//pathname中传递的值可以不在params中重复传递
var m=d[k]||[];return m.forEach(function(a){b[l]&&delete b[l][a]}),j},"")}else b=h;//将带_前缀的变量放到hashData中
var j=[].concat(g);j[0]=excludeDefaultData(b,config.defaultRouteParams);var k=[],l=[];return j.forEach(function(a,b){var c=extractHashData(a),d=c.search,e=c.hash;d&&(k[b]=d),e&&(l[b]=e)}),{pathname:i,search:"?"+joinSearchString(k),hash:"#"+joinSearchString(l)}}}}// export function buildTransformRoute(routeConfig: RouteConfig): TransformRoute {
