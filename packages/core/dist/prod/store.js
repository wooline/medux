 ...
 * store侦听器，判断是否时光
 */var invalidViewTimer;function checkInvalidview(){invalidViewTimer=0;var a=MetaData.clientStore._medux_.currentViews,b={};for(var c in a)if(a.hasOwnProperty(c)){var d=a[c];for(var e in d)if(d[e]){var f=Object.keys(d[e]).length;f&&(!b[c]&&(b[c]={}),b[c][e]=!0)}}// MetaData.clientStore.dispatch(viewInvalidAction(views));
}export function invalidview(){MetaData.isServer||!invalidViewTimer&&(invalidViewTimer=setTimeout(checkInvalidview,300))}export function viewWillMount(a,b,c){if(!MetaData.isServer){var d=MetaData.clientStore._medux_.currentViews;if(!d[a]){var e,f;d[a]=(f={},f[b]=(e={},e[c]=!0,e),f)}else{var h=d[a];if(!h[b]){var g;h[b]=(g={},g[c]=!0,g)}else h[b][c]=!0}invalidview()}}export function viewWillUnmount(a,b,c){if(!MetaData.isServer){var d=MetaData.clientStore._medux_.currentViews;if(d[a]&&d[a][b]){var e=d[a][b];delete e[c]}invalidview()}}// function excludeDefaultParams(data:any){
