...
export { renderApp, renderSSR, BaseModuleHandlers, defineModuleGetter, exportFacade, exportModule, loadModel, isPromiseModule, isPromiseView, getView } from './module';
