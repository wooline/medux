...
export declare function renderApp<M extends ModuleGetter, A extends Extract<keyof M, string>>(render: (Provider: ComponentType<{
    children: ReactNode;
}>, AppMainView: ComponentType<any>, ssrInitStoreKey: string) => void, moduleGetter: M, appModuleName: A, storeOptions: StoreOptions): Promise<void>;
export declare function renderSSR<M extends ModuleGetter, A extends Extract<keyof M, string>>(render: (Provider: ComponentType<{
    children: ReactNode;
}>, AppMainView: ComponentType<any>) => any, moduleGetter: M, appModuleName: A, storeOptions?: StoreOptions): Promise<{
    html: any;
    data: any;
